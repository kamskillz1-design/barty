...
const translations = {
  en: {
    ...
    v1cat: { electronics_technology: 'Electronics & Technology', home_furniture: 'Home & Furniture', fashion_personal: 'Fashion & Personal', books_education: 'Books & Education', creative_design: 'Creative & Design', digital_online_services: 'Digital & Online Services', repairs_practical: 'Repairs & Practical Services', business_professional: 'Business & Professional Services', vehicles_transport: 'Vehicles & Transport', sports_hobbies: 'Sports, Hobbies & Recreation', collectibles_vintage: 'Collectibles & Vintage', food_garden_homemade: 'Food, Garden & Homemade Goods' },
  ...
  es: {
    ...
    v1cat: { electronics_technology: 'Electrónica y Tecnología', home_furniture: 'Hogar y Mobiliario', fashion_personal: 'Moda y Personal', books_education: 'Libros y Educación', creative_design: 'Creativo y Diseño', digital_online_services: 'Servicios Digitales y en Línea', repairs_practical: 'Reparaciones y Servicios Prácticos', business_professional: 'Servicios Empresariales y Profesionales', vehicles_transport: 'Vehículos y Transporte', sports_hobbies: 'Deportes, Aficiones y Recreación', collectibles_vintage: 'Coleccionables y Vintage', food_garden_homemade: 'Alimentos, Jardín y Artesanías' },
  ...
  fr: {
    ...
    v1cat: { electronics_technology: 'Électronique & Technologie', home_furniture: 'Maison & Ameublement', fashion_personal: 'Mode & Personnel', books_education: 'Livres & Éducation', creative_design: 'Créatif & Design', digital_online_services: 'Services Numériques & en Ligne', repairs_practical: 'Réparations & Services Pratiques', business_professional: 'Services Professionnels & aux Entreprises', vehicles_transport: 'Véhicules & Transport', sports_hobbies: 'Sports, Loisirs & Récréation', collectibles_vintage: 'Objets de Collection & Vintage', food_garden_homemade: 'Alimentation, Jardin & Fait Maison' },
  ...
  ar: {
    ...
    v1cat: { electronics_technology: 'الإلكترونيات والتقنية', home_furniture: 'المنزل والأثاث', fashion_personal: 'الأزياء والمظهر', books_education: 'الكتب والتعليم', creative_design: 'الإبداع والتصميم', digital_online_services: 'الخدمات الرقمية وأونلاين', repairs_practical: 'الإصلاحات والخدمات العملية', business_professional: 'الخدمات التجارية والمهنية', vehicles_transport: 'المركبات والنقل', sports_hobbies: 'الرياضة والهوايات والترفيه', collectibles_vintage: 'المقتنيات والتحف', food_garden_homemade: 'الأغذية والحديقة والمنتجات المنزلية' },
