...
const translations = {
  ...
  ar: {
    ...
    listing: { new: 'إعلان جديد', title: 'العنوان', description: 'الوصف', intent: 'أنا', offering: 'أعرض', seeking: 'أبحث عن', offeringHint: 'أعرض هذا السلعة أو الخدمة', seekingHint: 'أبحث عن هذا السلعة أو الخدمة', seekingField: 'ما أبحث عنه', seekingPlaceholder: 'ابحث عن عناصر أو مهارات...', seekingAdd: 'إضافة', lookingFor: 'يبحث عن', type: 'النوع', good: 'سلعة', service: 'خدمة', category: 'الفئة', country: 'الدولة', city: 'المدينة / البلدة', town: 'القرية / المنطقة', language: 'اللغة', images: 'الصور', addImage: 'أضف رابط صورة', save: 'حفظ الإعلان', cancel: 'إلغاء', edit: 'تعديل', delete: 'حذف', back: 'رجوع', by: 'بواسطة', location: 'الموقع', proposeTrade: 'اقترح مقايضة', fulfillRequest: 'قدّم هذا', myListing: 'إعلانك', propose: 'اقترح', valueHint: 'يتم حساب العدالة داخليًا — لا تظهر الأسعار مطلقًا.', contact: 'تواصل', noImages: 'لا صور بعد' },
