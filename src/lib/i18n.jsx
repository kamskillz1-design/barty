...
const translations = {
  en: {
    ...
    search: { placeholder: 'Search listings...', location: 'Location', radius: 'Radius (km)', allLocations: 'All locations', category: 'Category', allCategories: 'All categories', type: 'Type', allTypes: 'All', goods: 'Goods', services: 'Services', search: 'Search', clear: 'Clear' },
  ...
  es: {
    ...
    search: { placeholder: 'Buscar anuncios...', location: 'Ubicación', radius: 'Radio (km)', allLocations: 'Todas las ubicaciones', category: 'Categoría', allCategories: 'Todas', type: 'Tipo', allTypes: 'Todos', goods: 'Bienes', services: 'Servicios', search: 'Buscar', clear: 'Limpiar' },
  ...
  fr: {
    ...
    search: { placeholder: 'Rechercher des annonces...', location: 'Lieu', radius: 'Rayon (km)', allLocations: 'Tous les lieux', category: 'Catégorie', allCategories: 'Toutes', type: 'Type', allTypes: 'Tous', goods: 'Biens', services: 'Services', search: 'Rechercher', clear: 'Effacer' },
  ...
  ar: {
    ...
    search: { placeholder: 'ابحث في الإعلانات...', location: 'الموقع', radius: 'نصف القطر (كم)', allLocations: 'كل المواقع', category: 'الفئة', allCategories: 'كل الفئات', type: 'النوع', allTypes: 'الكل', goods: 'سلع', services: 'خدمات', search: 'بحث', clear: 'مسح' },
    ...
    listing: { new: 'إعلان جديد', title: 'العنوان', description: 'الوصف', type: 'النوع', good: 'سلعة', service: 'خدمة', category: 'الفئة', country: 'الدولة', city: 'المدينة / البلدة', town: 'القرية / المنطقة', images: 'الصور', addImage: 'أضف رابط صورة', save: 'حفظ الإعلان', cancel: 'إلغاء', edit: 'تعديل', delete: 'حذف', back: 'رجوع', by: 'بواسطة', location: 'الموقع', proposeTrade: 'اقترح مقايضة', myListing: 'إعلانك', propose: 'اقترح', valueHint: 'يتم حساب العدالة داخليًا — لا تظهر الأسعار مطلقًا.', contact: 'تواصل', noImages: 'لا صور بعد' },
